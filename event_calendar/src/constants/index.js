...
export const UK_CITIES = [
  ...
  "Middlesbrough", "Hull", "West Bromwich", "Peterborough", "Stockport", "Telford", "Exeter", "Southend-on-Sea", "Walsall",
  "Maidstone", "Blackburn", "Oldham", "Woking", "Cheltenham", "Chelmsford", "Colchester", "Crawley", "Gillingham", "Basingstoke",
  "Worcester", "Rotherham", "Stockton-on-Tees", "Worthing", "Hastings", "Mansfield", "Oxford", "Slough", "Eastbourne", "Gloucester",
